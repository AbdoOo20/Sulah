      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items:  <BottomNavigationBarItem>[
          BottomNavigationBarItem(
            icon: const SVGIcon(Assets.homeIcon,color: Colors.grey,),
            activeIcon: const SVGIcon(Assets.homeIcon,color: AppColors.primaryColor,),
            label: tr("khedmaty"),
          ),
          BottomNavigationBarItem(
            icon:  const SVGIcon(Assets.category,color: Colors.grey,),
            activeIcon: const SVGIcon(Assets.category,color: AppColors.primaryColor,),
            label: tr(LocaleKeys.departments),
          ),
          BottomNavigationBarItem(
            icon: const SVGIcon(Assets.myOrders,color: Colors.grey,),
            activeIcon:const SVGIcon(Assets.myOrders,color: AppColors.primaryColor,),
            label: tr('orders'),
          ),
          BottomNavigationBarItem(
            icon:const SVGIcon(Assets.settingsIcon,color: Colors.grey,),
            activeIcon:const SVGIcon(Assets.settingsIcon,color: AppColors.primaryColor,),
           label: tr('myAccount'),
          ),
        ],
