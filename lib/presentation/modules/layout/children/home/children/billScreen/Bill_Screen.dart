...
class _BillScreenState extends State<BillScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer2<ShoppingCaredViewModel,CartProvider>(builder: (context,shopping, cart, child)=>CustomScaffold(
        appBar: CustomAppBar(
          ...
          children: [
                ...
                child:  ListAnimator(
                  children: [
                    PaymentAndLocationCard(
                      ...
                      paymentMethodTitle: shopping.paymentType??'',
            ...
            Padding(
              ...
              child: CustomButton(
                ...
                onTap: (){
                  Provider.of<ShoppingCaredViewModel>(context, listen: false).calculateOrderCost(context: context, isDelivery: widget.isDelivery);
                },
